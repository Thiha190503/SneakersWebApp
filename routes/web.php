...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin_auth'])->group(function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::get('details/{id}', [UserController::class, 'userDetails'])->name('admin#userDetails');
        ...
        Route::prefix('contact')->group(function () {
            ...
            Route::get('read/{id}', [ContactController::class, 'read'])->name('admin#contactRead');
    ...
    Route::group(['prefix' => 'user', 'middleware' => 'user_auth'], function () {
        ...
        Route::get('/showHomePage', [UserController::class, 'showHomePage'])->name('user#showHomePage');
        Route::get('/contact', [UserController::class, 'contact'])->name('user#contact');
        Route::post('/contact', [UserController::class, 'contactMessage'])->name('user#contactMessage');
        Route::get('/filter/{id}', [UserController::class, 'filter'])->name('user#filter');
        Route::get('/history', [UserController::class, 'history'])->name('user#history'); // *****

        Route::prefix('product')->group(function () {
            Route::get('details/{id}', [UserController::class, 'productDetails'])->name('user#productDetails');
            Route::post('review/add', [ReviewController::class, 'reviewAdd'])->name('user#reviewAdd');
            Route::get('review/delete/{id}', [ReviewController::class, 'reviewDelete'])->name('user#reviewDelete');
        });
